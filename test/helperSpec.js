describe("rasterizeHTMLTestHelper", function () {
    ...
    describe("toEqualImage matcher", function () {
        ...
        it("should fail on different images", function () {
            ...
            expect(rasterizeHTMLTestHelper.imageEquals(a, b)).toBe(false);
        });
        ...
        it("should pass on similar images", function () {
            ...
            expect(rasterizeHTMLTestHelper.imageEquals(a, b)).toBe(true);
        });
        ...
        it("should pass when not surpassing threshold", function () {
            ...
            expect(rasterizeHTMLTestHelper.imageEquals(a, b, 50)).toBe(true);
        });
        ...
        it("should not pass when surpassing threshold", function () {
            ...
            expect(rasterizeHTMLTestHelper.imageEquals(a, b, 50)).toBe(false);
        });
        ...
        it("should pass when not surpassing minimal threshold", function () {
            ...
            expect(rasterizeHTMLTestHelper.imageEquals(a, b, 0.1)).toBe(true);
        });
    });
    ...
    describe("toEqualImage matcher", function () {
        ...
        it("should delegate to imageEqual", function () {
            var toEqualImageSpy = spyOn(rasterizeHTMLTestHelper, 'imageEquals').andReturn(true);
