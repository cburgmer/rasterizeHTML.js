describe("Inline CSS content", function () {
    ...
    describe("loadCSSImportsForRules", function () {
        ...
        it("should replace an import with the content of the given URL", function () {
            ...
            rasterizeHTMLInline.css.loadCSSImportsForRules(rules, '', false, [], callback);
        ...
        it("should handle a baseUrl", function () {
            ...
            rasterizeHTMLInline.css.loadCSSImportsForRules(rules, 'url_base/page.html', false, [], callback);
        ...
        it("should not circumvent caching by default", function () {
            ...
            rasterizeHTMLInline.css.loadCSSImportsForRules(rules, '', true, [], callback);
        ...
        describe("error handling", function () {
            ...
            it("should include the base URI in the reported url", function () {
                ...
                rasterizeHTMLInline.css.loadCSSImportsForRules(rules, 'some_url/', true, [], callback);
    ...
    describe("loadAndInlineCSSResourcesForRules", function () {
        ...
        it("should work with empty content", function () {
            rasterizeHTMLInline.css.loadAndInlineCSSResourcesForRules([], '', true, callback);
        ...
        describe("on background-image", function () {
            it("should not touch an already inlined background-image", function () {
                ...
                rasterizeHTMLInline.css.loadAndInlineCSSResourcesForRules(rules, '', true, callback);
            ...
            it("should handle a baseUrl", function () {
                ...
                rasterizeHTMLInline.css.loadAndInlineCSSResourcesForRules(rules, 'url_base/page.html', true, callback);
            ...
            it("should circumvent caching if requested", function () {
                ...
                rasterizeHTMLInline.css.loadAndInlineCSSResourcesForRules(rules, '', false, callback);
        ...
        describe("on background-image with errors", function () {
            ...
            it("should report an error if a backgroundImage could not be loaded", function () {
                ...
                rasterizeHTMLInline.css.loadAndInlineCSSResourcesForRules(rules, 'some_base_url/', true, callback);
    ...
    describe("workAroundWebkitBugIgnoringTheFirstRuleInCSS", function () {
        ...
        it("should add a workaround for Webkit to account for first CSS rules being ignored on background-images", function () {
            ...
            newContent = rasterizeHTMLInline.css.workAroundWebkitBugIgnoringTheFirstRuleInCSS(content, rules);
