describe("Inline utilities function", function () {
    ...
    describe("parseOptionalParameters", function () {
        ...
        it("should copy options", function () {
            var params = rasterizeHTMLInline.util.parseOptionalParameters(canvas, options, callback);
        ...
        it("should deal with a null canvas", function () {
            var params = rasterizeHTMLInline.util.parseOptionalParameters(null, options, callback);
        ...
        it("should make options optional", function () {
            var params = rasterizeHTMLInline.util.parseOptionalParameters(canvas, callback);
            expect(params.canvas).toBe(canvas);
        ...
        it("should make callback optional", function () {
            var params = rasterizeHTMLInline.util.parseOptionalParameters(canvas, options);
            expect(params.canvas).toBe(canvas);
            expect(params.options).toEqual(options);
        ...
        it("should work with canvas only", function () {
            var params = rasterizeHTMLInline.util.parseOptionalParameters(canvas);
            expect(params.canvas).toBe(canvas);
            expect(params.options).toEqual({});
            expect(params.callback).toBe(null);
        });
